<?php
	...
	$drive = 'C:/xampp/htdocs/aplikasi_peserta_sertifikasi/backup/';
	//database yang tidak ingin di backup
	$lewati = array('mysql', 'information_schema','performance_schema','phpmyadmin');
	//Proses Di Mulai
	...
	echo(	"<script type='text/javascript'>alert('DATABASE BERHASIL DIBACKUP!');
